 ...
 * @since 1.0
 */
public class DkRoundLinearLayout extends LinearLayout implements DkRoundAction {

    private DkRoundHelper mRoundHelper = new DkRoundHelper();

    public DkRoundLinearLayout(Context context) {
        this(context, null);
    }

    public DkRoundLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DkRoundLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
