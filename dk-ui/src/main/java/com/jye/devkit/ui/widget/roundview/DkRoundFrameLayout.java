 ...
 * @since 1.0
 */
public class DkRoundFrameLayout extends FrameLayout implements DkRoundAction {

    private DkRoundHelper mRoundHelper = new DkRoundHelper();

    public DkRoundFrameLayout(Context context) {
        this(context, null);
    }

    public DkRoundFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DkRoundFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
