...
/**
 * 可以用Layout包装RadioButton的自定义RadioGroup
 *
 * @author jye
 * @since 1.0
 */
public class DkRadioLayoutGroup extends LinearLayout {
    ...
    public DkRadioLayoutGroup(Context context) {
        super(context);
        setOrientation(LinearLayout.VERTICAL);
        init();
    }

    public DkRadioLayoutGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * <p>
     * <p>
     * See {@link android.R.style＃LinearLayout_Layout LinearLayout
     * <p>
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(DkRadioLayoutGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == DkRadioLayoutGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == DkRadioLayoutGroup.this && child instanceof ViewGroup) {
