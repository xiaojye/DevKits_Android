 ...
 * @since 1.0
 */
public class DkRoundView extends View implements DkRoundAction {

    private DkRoundHelper mRoundHelper = new DkRoundHelper();

    public DkRoundView(Context context) {
        this(context, null);
    }

    public DkRoundView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DkRoundView(Context context, AttributeSet attrs, int defStyleAttr) {
