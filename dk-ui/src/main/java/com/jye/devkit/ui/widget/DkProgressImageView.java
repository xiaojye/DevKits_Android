...
/**
 * 带进度的图片控件（一般用于显示上传进度等）
 *
 * @author jye
 * @since 1.0
 */
public class DkProgressImageView extends AppCompatImageView {
    private Context context;
    private Paint paint;
    int progress = 0;
    private boolean flag;

    public DkProgressImageView(Context context) {
        super(context);
    }

    public DkProgressImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DkProgressImageView(Context context, AttributeSet attrs, int defStyleAttr) {
