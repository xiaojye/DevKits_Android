 ...
 * @since 1.0
 */
public class DkObservableScrollView extends ScrollView {

    private int mScrollOffset = 0;

    private List<OnScrollChangedListener> mOnScrollChangedListeners;

    public DkObservableScrollView(Context context) {
        super(context);
    }

    public DkObservableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DkObservableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnScrollChangedListener {
        void onScrollChanged(DkObservableScrollView scrollView, int scrollX, int scrollY, int oldScrollX, int oldScrollY);
    }
