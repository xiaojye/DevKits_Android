 ...
 * @since 1.0
 */
public final class DkRoundHelper implements DkRoundAction {
    ...
    public void init(View view, AttributeSet attrs) {
        ...
        TypedArray typedArray = view.getContext().obtainStyledAttributes(attrs, R.styleable.RARound);

        int radius = typedArray.getDimensionPixelSize(R.styleable.RARound_dk_cornerRadius, 0);
        mRadiusTopLeft = typedArray.getDimensionPixelSize(R.styleable.RARound_dk_cornerRadiusTopLeft, radius);
        mRadiusTopRight = typedArray.getDimensionPixelSize(R.styleable.RARound_dk_cornerRadiusTopRight, radius);
        mRadiusBottomLeft = typedArray.getDimensionPixelSize(R.styleable.RARound_dk_cornerRadiusBottomLeft, radius);
        mRadiusBottomRight = typedArray.getDimensionPixelSize(R.styleable.RARound_dk_cornerRadiusBottomRight, radius);

        mIsCircle = typedArray.getBoolean(R.styleable.RARound_dk_round_isCircle, false);

        mStrokeColor = typedArray.getColor(R.styleable.RARound_dk_borderColor, mStrokeColor);
        mStrokeWidth = typedArray.getDimension(R.styleable.RARound_dk_borderWidth, 0);
