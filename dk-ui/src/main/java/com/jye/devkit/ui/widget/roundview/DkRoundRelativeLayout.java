 ...
 * @since 1.0
 */
public class DkRoundRelativeLayout extends RelativeLayout implements DkRoundAction {

    private DkRoundHelper mRoundHelper = new DkRoundHelper();

    public DkRoundRelativeLayout(Context context) {
        this(context, null);
    }

    public DkRoundRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DkRoundRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
