 ...
 * @since 1.0
 */
public class DkRoundTextView extends AppCompatTextView implements DkRoundAction {

    private DkRoundHelper mRoundHelper = new DkRoundHelper();

    public DkRoundTextView(Context context) {
        this(context, null);
    }

    public DkRoundTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DkRoundTextView(Context context, AttributeSet attrs, int defStyleAttr) {
