package com.jye.devkit.base.imageloader.builder;

import android.content.Context;

import com.jye.devkit.base.imageloader.DkImageLoader;
import com.jye.devkit.base.imageloader.DownloadProgressListener;
...
public class DownloadBuilder {
    ...
    public void execute(DownloadProgressListener listener) {
        ...
        DkImageLoader.getInstance().getEngine().download(request);
    }
