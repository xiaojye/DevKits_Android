package com.jye.devkit.base.http;

import androidx.annotation.NonNull;

import com.jye.devkit.base.http.provider.DefaultProvider;
import com.jye.devkit.base.http.provider.IHttpProvider;
import com.jye.devkit.base.json.gson.GsonFactory;
...
public final class DkRestful {
    ...
    private static DkRestful sInstance = null;

    private DkRestful() {
    }

    public static DkRestful getInstance() {
        if (sInstance == null) {
            synchronized (DkRestful.class) {
                if (sInstance == null) {
                    sInstance = new DkRestful();
                }
            }
        }
        return sInstance;
